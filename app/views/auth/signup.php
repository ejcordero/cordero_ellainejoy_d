...
<body class="flex items-center justify-center min-h-screen">
  ...
  <div class="glass p-10 rounded-3xl w-full max-w-md">
    ...
    <p class="text-center text-gray-200 mb-6">Sign up to start using CRUDero</p>
    ...
    <form action="<?= site_url('signup'); ?>" method="POST" class="space-y-6">
      ...
      <div class="text-center mt-6">
        <p class="text-gray-300 text-sm">
          ...
          <a href="<?= site_url('login'); ?>" class="text-indigo-400 hover:underline">Login here</a>
        </p>
      </div>
    </form>
  </div>
